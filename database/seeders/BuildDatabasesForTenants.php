...
class BuildDatabasesForTenants extends Seeder
{
    ...
    public function run()
    {
        ...
        $customers = [
            ['database' => 'customer_foo_tenancy', 'domain' => 'foo.multitenant.test', 'name' => 'Foo Customer', 'email' => 'customer@foo.com'],
            ['database' => 'customer_bar_tenancy', 'domain' => 'bar.multitenant.test', 'name' => 'Bar Customer', 'email' => 'customer@bar.com'],
            ['database' => 'customer_baz_tenancy', 'domain' => 'baz.multitenant.test', 'name' => 'Baz Customer', 'email' => 'customer@baz.com'],
        ];
